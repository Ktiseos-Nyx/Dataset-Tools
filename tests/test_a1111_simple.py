...
def test_a1111_simple(file_path: str):
    ...
    print(  # noqa: T201f"🔧 SIMPLE A1111 JPEG TEST FOR: {file_path}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Test A1111 JPEG metadata extraction using the new MetadataEngine."
    )
    parser.add_argument(
        "file_path", type=str, help="The absolute path to the A1111 JPEG file to test."
    )

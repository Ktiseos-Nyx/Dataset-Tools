...
class TestParseMetadata(unittest.TestCase):
    ...
    def test_arrange_webui_metadata(self):
        ...
        with (
            patch("dataset_tools.metadata_parser.delineate_by_esc_codes", mock_delineate_by_esc_codes),
            patch("dataset_tools.metadata_parser.extract_prompts", mock_extract_prompts),
            patch("dataset_tools.metadata_parser.extract_dict_by_delineation", mock_extract_dict_by_delineation),
    ...
    def test_validate_dictionary_structure(self):
        BracketedDict = type("BracketedDict", (object,), {"model_validate": lambda x: {'brackets': "annotated_value"}})
        possibly_valid = validate_dictionary_structure(self.actual_metadata)
        assert isinstance(possibly_valid,str)
        assert possibly_valid == ""

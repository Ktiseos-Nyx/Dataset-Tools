...
class TestDiskInterface(unittest.TestCase): # D203/D211 handled by formatter
    ...
    def tearDown(self): # D102
        ...
        file_list = [
            ...
            self.text_file_utf8, self.text_file_utf16be, self.text_file_complex_utf8,
            self.binary_content_in_txt_file, self.json_file, self.invalid_json_file,
            self.toml_file, self.invalid_toml_file, self.fake_model_file_path,
            self.unhandled_ext_file_path,
        ]

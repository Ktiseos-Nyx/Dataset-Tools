...
class MetadataDisplayManager:
    ...
    def display_metadata(self, metadata_dict: Optional[Dict[str, Any]]) -> None:
        """
    ...
    def get_all_display_text(self) -> str:
        ...
        box_configs = [
            ...
            ("generation_data_box", "generation_data_label", "Generation Details & Metadata"),
        ]
    ...
    def _get_box_content_with_label(self, box_attr: str, label_attr: str, 
                                   default_label: str) -> Optional[str]:
    ...
    def format_metadata_section(self, metadata_dict: Dict[str, Any], 
                               section_enum: Any) -> str:
        """
    ...
    def update_detected_tool_display(self, tool_name: str) -> None:
        ...
        if hasattr(self.main_window, 'generation_data_box'):
            text_box = getattr(self.main_window, 'generation_data_box')
            if isinstance(text_box, Qw.QTextEdit):

...
from PyQt6.QtWidgets import (
    QComboBox, QDialog, QDialogButtonBox, QLabel, QVBoxLayout, QWidget, QMessageBox
)
...
class SettingsDialog(QDialog):
    ...
    def __init__(self, parent: Optional[QWidget] = None, current_theme_xml: str = ""):
    ...
    def _populate_size_combo(self) -> None:
        ...
        self.size_presets: Dict[str, Optional[Tuple[int, int]]] = {
    ...
    def apply_theme_settings(self) -> None:
        ...
        if (selected_theme_xml and 
            self.parent_window and 
            hasattr(self.parent_window, "apply_theme")):
    ...
    def _should_revert_theme(self) -> bool:
        ...
        return (QT_MATERIAL_AVAILABLE and
                self.parent_window and
                hasattr(self.parent_window, "apply_theme") and
                self.current_theme_on_open and
                self._theme_has_changed())
...
def ask_yes_no_question(parent: Optional[QWidget], title: str, question: str) -> bool:
    """

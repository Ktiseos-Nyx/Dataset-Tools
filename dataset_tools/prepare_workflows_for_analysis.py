...
def prepare_workflow_batch(source_directory: str, output_directory: str, max_files: int = 100):
    ...
    with open(instructions_file, 'w', encoding='utf-8') as f:
        f.write(f"""# ComfyUI Workflow Analysis Instructions
            ...
            "smZ CLIPTextEncode": {
                ...
                "inputs": {
                    "text": {
                        ...
                        "observed_values": ["masterpiece, very aesthetic...", "embedding:urn:air:..."]
                    },
                    "clip": {
                        "type": "CLIP", 
                        "required": True,
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        ...
        print("Example: python prepare_workflows_for_analysis.py '/Users/duskfall/Downloads/Metadata Samples' './workflow_analysis' 100")
        sys.exit(1)

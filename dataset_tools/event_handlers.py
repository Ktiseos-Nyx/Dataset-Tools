...
def handle_file_selection(main_window: "MainWindow", current_item: Qw.QListWidgetItem | None) -> None:
...
def _handle_no_selection(main_window: "MainWindow") -> None:
    """Clear UI elements when no file is selected."""
    main_window.clear_selection()

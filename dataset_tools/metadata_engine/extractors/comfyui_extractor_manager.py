...
from .comfyui_searge import ComfyUISearcheExtractor
...
class ComfyUIExtractorManager:
    ...
    def __init__(self, logger: logging.Logger) -> None:
        ...
        self.searge = ComfyUISearcheExtractor(logger)
    ...
    def get_extractor_stats(self) -> Dict[str, Any]:
        ...
        stats = {
            ...
            "ecosystem_extractors": ["impact", "efficiency", "was", "animatediff", "controlnet", "searge", "rgthree", "inspire"],

...
class ComfyUIEfficiencyExtractor:
        ...
        for node_id, node_data in prompt_data.items():
            ...
            if "Efficient Loader" in class_type:
                ...
                if widgets:
                    ...
                    param_names = [
                        "ckpt_name", "vae_name", "clip_skip", "lora_name",
            ...
            if "Efficient Sampler" in class_type:
                ...
                if widgets:
                    ...
                    param_names = [
                        ...
                        "scheduler", "denoise", "preview_method", "vae_decode"
                    ]
        ...
        for node_id, node_data in prompt_data.items():
            ...
            if "Efficient KSampler" in class_type:
                ...
                if widgets:
                    ...
                    param_names = [
                        "seed", "steps", "cfg", "sampler_name",
                        "scheduler", "denoise", "preview_method",
                        "vae_decode", "use_tiled_vae", "tile_size"
                    ]
    ...
    def _extract_script_params(
        ...
        efficiency_script_nodes = [
            "Script", "HighRes-Fix Script", "NoiseControl Script",
            "AnimateDiff Script", "Upscale Script"
        ]
    ...
    def _detect_efficiency_workflow(
        ...
        efficiency_indicators = [
            "Efficient Loader", "Efficient Sampler", "Efficient KSampler",
            "HighRes-Fix Script", "NoiseControl Script", "AnimateDiff Script",
            "Upscale Script", "XY Plot", "Evaluate Integers", "Evaluate Floats",
            "Evaluate Strings", "Simple Eval Examples", "Control Script",
            "Tiled Sampler", "Tiled KSampler"
        ]
    ...
    def _is_efficiency_node(self, class_type: str) -> bool:
        ...
        efficiency_node_types = [
            ...
            "Upscale Script", "XY Plot", "Evaluate Integers", "Evaluate Floats",
            "Evaluate Strings", "Simple Eval Examples", "Control Script",
            "Tiled Sampler", "Tiled KSampler", "Image Scale", "Image Scale by Factor",
            "Unsampler", "Noise Control Script", "HiRes-Fix Script",
            "Efficient Attention", "Efficient LoRA Stack", "Efficient ControlNet Stack"
        ]

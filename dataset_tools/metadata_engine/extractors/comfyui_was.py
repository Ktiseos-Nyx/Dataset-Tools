...
class ComfyUIWASExtractor:
    ...
    def _extract_text_processing(
        ...
        was_text_nodes = [
            "Text Concatenate", "Text Replace", "Text Random Line",
            "Text Parse A1111", "Text Parse Noodle Soup Prompts",
            "Text Load Line From File", "Text Save To File",
            "Text String", "Text Multiline", "Text Switch",
            "Text Compare", "Text Contains", "Text List",
            "Text Random Choice", "Text Split", "Text Join",
            "Text Padding", "Text Uppercase", "Text Lowercase"
        ]
    ...
    def _extract_image_operations(
        ...
        was_image_nodes = [
            "Image Resize", "Image Crop", "Image Rotate", "Image Flip",
            "Image Blend", "Image Composite", "Image Filter",
            "Image Convert", "Image Save", "Image Load",
            "Image Batch", "Image Stack", "Image Grid",
            "Image Nova Filter", "Image Film Grain", "Image Pixelate",
            "Image Threshold", "Image Levels", "Image Curves",
            "Image Color Correct", "Image Gaussian Blur", "Image Sharpen",
            "Image Edge Enhance", "Image Posterize", "Image Solarize"
        ]
    ...
    def _extract_utility_nodes(
        ...
        # WAS utility nodes
        was_utility_nodes = [
            "Number", "Integer", "Float", "Boolean", "String",
            "Number Operation", "Number Compare", "Number Switch",
            "Logic Boolean", "Logic Compare", "Logic Switch",
            "Seed", "Random Number", "Random Choice",
            "Dictionary", "List", "Tuple",
            "CLIPSeg", "Mask", "Mask Crop", "Mask Expand",
            "Mask Threshold", "Mask Blur", "Mask Erode", "Mask Dilate",
            "Console Debug", "Note", "Any Switch", "Any Type"
        ]
    ...
    def _extract_conditioning_nodes(
        ...
        was_conditioning_nodes = [
            "Conditioning Set Area", "Conditioning Set Mask",
            "Conditioning Combine", "Conditioning Average",
            "Conditioning Concat", "Conditioning Set Timestep Range",
            "CLIP Text Encode", "CLIP Text Encode Advanced",
            "CLIP Vision Encode", "CLIP Interrogate",
            "Style Prompt", "Prompt Styler", "Prompt Switch"
        ]
    ...
    def _detect_was_workflow(
        ...
        was_indicators = [
            "WAS_", "Text ", "Image ", "Number", "Logic", "Mask",
            "CLIPSeg", "Console Debug", "Note", "Any Switch",
            "Random", "Dictionary", "List", "Tuple", "Boolean",
            "Style Prompt", "Prompt Styler"
        ]
    ...
    def _is_was_node(self, class_type: str) -> bool:
        ...
        was_node_prefixes = [
            ...
            "CLIPSeg", "Console Debug", "Note", "Any Switch",
            "Random", "Dictionary", "List", "Tuple", "Boolean",
            "Style Prompt", "Prompt Styler", "Seed", "Float",
            "Integer", "String"
        ]
    ...
    def extract_was_text_content(self, data: dict) -> list[str]:
        ...
        for node_id, node_data in prompt_data.items():
            ...
            if ("Text " in class_type or "WAS_" in class_type) and any(
                text_type in class_type for text_type in [
                    "String", "Multiline", "Concatenate", "Replace",
                    "Random Line", "Parse", "Load Line", "Save"
                ]
            ):
                widgets = node_data.get("widgets_values", [])

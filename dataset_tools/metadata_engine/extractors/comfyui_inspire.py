...
class ComfyUIInspireExtractor:
    ...
    def _extract_regional_prompts(
        ...
        inspire_regional_nodes = [
            "RegionalPrompt", "RegionalConditioningSimple",
            "RegionalConditioningColorMask", "RegionalSampler",
            "RegionalSamplerAdvanced", "RegionalIPAdapterColorMask",
            "RegionalIPAdapterMask", "RegionalControlNetSimple",
            "RegionalControlNetColorMask", "RegionalControlNetMask",
            "CombineRegionalPrompts", "ApplyRegionalIPAdapters",
            "RegionalPromptColorMask", "RegionalPromptSimple"
        ]
    ...
    def _extract_batch_nodes(
        ...
        inspire_batch_nodes = [
            "BatchCreativeInterpolation", "BatchPromptSchedule",
            "BatchPromptScheduleSimple", "BatchValueSchedule",
            "BatchValueScheduleSimple", "BatchFloatSchedule",
            "BatchIntSchedule", "BatchStringSchedule",
            "BatchImageLoader", "BatchImageSaver",
            "BatchLatentSchedule", "BatchConditioningSchedule",
            "BatchModelSchedule", "BatchClipSchedule",
            "BatchVaeSchedule", "BatchSeedSchedule"
        ]
    ...
    def _extract_utility_nodes(
        ...
        inspire_utility_nodes = [
            "WildcardProcessor", "WildcardProcessorSimple",
            "WildcardEncode", "WildcardEncodeSimple",
            "GlobalSeed", "GlobalSeedSimple", "GlobalSeedAdvanced",
            "PromptBuilder", "PromptBuilderSimple",
            "PromptExtractor", "PromptExtractorSimple",
            "StringFunction", "StringFunctionSimple",
            "MathFunction", "MathFunctionSimple",
            "CacheBackendData", "CacheBackendDataSimple",
            "LoadPromptsFromFile", "LoadPromptsFromDir",
            "SavePromptsToFile", "CheckpointName",
            "ModelName", "LoraName", "VaeName",
            "ImageBatchSplitter", "ImageBatchMerger",
            "LatentBatchSplitter", "LatentBatchMerger"
        ]
    ...
    def _extract_sampler_nodes(
        ...
        inspire_sampler_nodes = [
            "KSamplerAdvanced", "KSamplerPipe", "KSamplerProgress",
            "KSamplerProgressSimple", "KSamplerInspire",
            "KSamplerInspireSimple", "InspireSampler",
            "InspireSamplerAdvanced", "InspireSamplerSimple",
            "DualCLIPLoader", "DualCLIPLoaderSimple",
            "UnCLIPCheckpointLoader", "UnCLIPCheckpointLoaderSimple",
            "DifferentialDiffusion", "DifferentialDiffusionSimple",
            "HyperTile", "HyperTileSimple"
        ]
    ...
    def _extract_conditioning_nodes(
        ...
        inspire_conditioning_nodes = [
            "CLIPTextEncodeWithWeight", "CLIPTextEncodeSimple",
            "CLIPTextEncodeAdvanced", "CLIPTextEncodeRegional",
            "ConditioningUpscale", "ConditioningUpscaleSimple",
            "ConditioningStretch", "ConditioningStretchSimple",
            "ConditioningMultiply", "ConditioningMultiplySimple",
            "ConditioningNormalize", "ConditioningNormalizeSimple",
            "ConditioningConcat", "ConditioningConcatSimple",
            "ConditioningBlend", "ConditioningBlendSimple",
            "ConditioningMix", "ConditioningMixSimple"
        ]
    ...
    def _detect_inspire_workflow(
        ...
        inspire_indicators = [
            "Regional", "Batch", "Wildcard", "GlobalSeed",
            "PromptBuilder", "PromptExtractor", "StringFunction",
            "MathFunction", "CacheBackend", "LoadPrompts",
            "SavePrompts", "CheckpointName", "ModelName",
            "LoraName", "VaeName", "ImageBatch", "LatentBatch",
            "KSamplerInspire", "InspireSampler", "DualCLIP",
            "UnCLIPCheckpoint", "DifferentialDiffusion", "HyperTile",
            "CLIPTextEncodeWithWeight", "ConditioningUpscale",
            "ConditioningStretch", "ConditioningMultiply",
            "ConditioningNormalize", "ConditioningConcat",
            "ConditioningBlend", "ConditioningMix"
        ]

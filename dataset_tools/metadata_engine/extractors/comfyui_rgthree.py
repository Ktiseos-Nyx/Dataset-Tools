...
class ComfyUIRGthreeExtractor:
    ...
    def _extract_context_nodes(
        ...
        rgthree_context_nodes = [
            "Context", "Context Switch", "Context Merge",
            "Context Big", "Context Switch Big", "Context Merge Big",
            "SDXL Context", "SDXL Context Big", "SDXL Context Switch",
            "Fast Groups Bypasser", "Fast Groups Muter"
        ]
    ...
    def _extract_power_prompts(
        ...
        rgthree_prompt_nodes = [
            "Power Prompt", "Power Prompt Simple", "Power Prompt Advanced",
            "Prompt Combiner", "Prompt Combiner +", "Prompt Combiner ++",
            "Power Lora Loader", "Power Lora Loader Simple",
            "Power Lora Loader Advanced", "Power Lora Stack"
        ]
    ...
    def _extract_reroute_nodes(
        ...
        rgthree_reroute_nodes = [
            "Reroute", "Reroute Resizer", "Reroute Big",
            "Any Switch", "Any Switch Big", "Any Switch ++",
            "String Switch", "Integer Switch", "Float Switch",
            "Boolean Switch", "Latent Switch", "Image Switch",
            "Conditioning Switch", "Model Switch", "VAE Switch",
            "CLIP Switch", "ControlNet Switch"
        ]
    ...
    def _extract_utility_nodes(
        ...
        rgthree_utility_nodes = [
            "Bookmark", "Config File", "Display Text",
            "Display Int", "Display Float", "Display Boolean",
            "Display Latent", "Display Image", "Display Any",
            "Random Unmuter", "Random Bypasser", "Random Bool",
            "Random Int", "Random Float", "Random String",
            "Seed", "Seed ++", "Seed O' Plenty",
            "Image Comparer", "Image Comparer Simple",
            "Image Saver", "Image Saver Simple"
        ]
    ...
    def _extract_workflow_nodes(
        ...
        rgthree_workflow_nodes = [
            "Queue", "Queue Simple", "Queue Advanced",
            "Workflow", "Workflow Simple", "Workflow Advanced",
            "Checkpoint", "Checkpoint Simple", "Checkpoint Advanced",
            "Progress", "Progress Simple", "Progress Advanced",
            "Timer", "Timer Simple", "Timer Advanced",
            "Logger", "Logger Simple", "Logger Advanced"
        ]
    ...
    def _detect_rgthree_workflow(
        ...
        rgthree_indicators = [
            "Context", "Power Prompt", "Reroute", "Switch",
            "Bookmark", "Display", "Random", "Seed", "Config",
            "Image Comparer", "Image Saver", "Queue", "Workflow",
            "Checkpoint", "Progress", "Timer", "Logger",
            "Bypasser", "Muter", "Combiner", "Lora Stack"
        ]
    ...
    def _is_rgthree_node(self, class_type: str) -> bool:
        ...
        rgthree_indicators = [
            ...
            "Checkpoint", "Progress", "Timer", "Logger",
            "Bypasser", "Muter", "Combiner", "Lora Stack",
            "Power Lora", "Fast Groups", "String Switch",
            "Integer Switch", "Float Switch", "Boolean Switch"
        ]

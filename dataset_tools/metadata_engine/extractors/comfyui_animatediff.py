...
class ComfyUIAnimateDiffExtractor:
            ...
            if "AnimateDiffLoader" in class_type:
                ...
                if widgets:
                    motion_module = {
                        ...
                        "motion_scale": widgets[2] if len(widgets) > 2 and isinstance(widgets[2], (int, float)) else 1.0,
    ...
    def _detect_animatediff_workflow(
        ...
        animatediff_indicators = [
            "AnimateDiff", "ADE_AnimateDiff", "AnimateDiffLoader",
            "AnimateDiffSampler", "AnimateDiffUniformContextOptions",
            "LoopedUniformContextOptions", "AnimateDiffContextOptions",
            "ADE_ControlNetLoaderAdvanced", "ADE_ControlNetApplyAdvanced"
        ]
    ...
    def _is_animatediff_node(self, class_type: str) -> bool:
        ...
        animatediff_node_types = [
            ...
            "LoopedUniformContextOptions", "AnimateDiffContextOptions",
            "ADE_ControlNetLoaderAdvanced", "ADE_ControlNetApplyAdvanced",
            "ADE_AnimateDiffLoaderGen1", "ADE_AnimateDiffSampler",

...
class ComfyUIComplexityExtractor:
    ...
    def _find_dynamic_prompt_generators(self, prompt_data: dict) -> list[dict]:
        ...
        dynamic_node_types = [
            "DPRandomGenerator", "RandomGenerator", "ImpactWildcardProcessor",
            "WildcardProcessor", "DynamicPrompts", "AdvancedPromptGenerator",
            "ConditionalPrompt", "PromptGenerator", "TextGenerator"
        ]
            ...
            if widgets:
                ...
                for widget in widgets:
                    if isinstance(widget, str) and len(widget.strip()) > 20:
                        ...
                        if any(word in widget.lower() for word in ["score_", "rating_", "source_", "photograph", "realistic", "quality"]):
                            return widget.strip()
    ...
    def _find_final_nodes(self, prompt_data: dict) -> dict:
        ...
        final_node_types = [
            ...
            "DPMSolverMultistep", "EulerAncestralSampler", "UniPCMultistep",
            "SaveImage", "PreviewImage", "VaeEncode", "VaeDecode"
        ]
    ...
    def _find_complex_text_processors(self, prompt_data: dict) -> list[dict]:
        ...
        complex_types = [
            "AdvancedPromptGenerator", "ConditionalPrompt", "PromptMixer",
            "TextProcessor", "PromptEnhancer", "StyleApplicator",
            "PromptWeighting", "AttentionProcessor"
        ]
    ...
    def _is_core_node(self, class_type: str) -> bool:
        ...
        core_nodes = [
            "CLIPTextEncode", "KSampler", "CheckpointLoader", "VAELoader",

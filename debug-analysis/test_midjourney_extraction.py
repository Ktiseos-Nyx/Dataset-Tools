...
def test_midjourney_extraction():
    ...
    test_results = [
        ("Extract prompt", prompt_result and prompt_result.strip() == "beautiful landscape with mountains and trees"),
        ...
        ("FieldExtractor integration", integrated_result and integrated_result.strip() == "beautiful landscape with mountains and trees"),
